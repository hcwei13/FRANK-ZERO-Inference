...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        if attention_mask is not None:  # no matter the length, we just slice it
            ...
            # if causal_mask.shape[-1] == causal_mask.shape[-2]: #TODO WHC
            #     # causal_mask[:, :, -1, :1325] = causal_mask[:, :, -1, :1325] + causal_mask[:, :, 1325, -1] 
            #     causal_mask[:, :, -1, :301] = causal_mask[:, :, -1, :301] + causal_mask[:, :, 250, -1] 
